...
### هدف
یک سیستم جامع تحلیل تمرینات ورزشی در زمان واقعی که از بینایی کامپیوتری و یادگیری ماشین برای تشخیص دقیق فرم و مربی‌گری استفاده می‌کند. این سیستم به‌طور خاص برای مسابقات AIO CUP توسعه یافته و تحلیل فریم به فریم حرکات ورزشی با مکانیزم‌های بازخورد دقیق ارائه می‌دهد.
